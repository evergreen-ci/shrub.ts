...
proto.shrub.Configuration.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    stepback: jspb.Message.getFieldWithDefault(msg, 10, false),
  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.shrub.CommandDefinition.deserializeBinaryFromReader, "");
         });
      break;
    case 2:
...
proto.shrub.CommandDefinition.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    variantsList: jspb.Message.getRepeatedField(msg, 5),
...
proto.shrub.Variant.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    runOnList: jspb.Message.getRepeatedField(msg, 5),
...
proto.shrub.DisplayTaskDefinition.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    executionTasksList: jspb.Message.getRepeatedField(msg, 2)
  };
...
proto.shrub.TaskSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    stepback: jspb.Message.getFieldWithDefault(msg, 2, false),
    distroList: jspb.Message.getRepeatedField(msg, 3)
  };
...
proto.shrub.TaskGroup.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.shrub.CommandDefinition.toObject, includeInstance),
    tasksList: jspb.Message.getRepeatedField(msg, 5),
